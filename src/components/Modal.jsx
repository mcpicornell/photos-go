...
export const Modal = (props) => {
  ...
  const updateDescription = (event) => {
    ...
    dispatch(
      changeDescription({ id: props.info.id, description: descriptionValue })
    );
  ...
  return (
    <>
      <ModalContainer>
        <div id="modalCardFav">
          <h3 id="photoInfo" className="containerElements">
            Photo info
          </h3>

          <div id="arrowImgContainer" className="containerElements">
            <img src={imgArrowLeft} onClick={closeModal} alt="arrowLeft"/>
          </div>

          <div id="infoImgContainer" className="containerElements">
            <img src={props.info.urlsFull} alt="urlPhoto"/>
          </div>
